...
---
As our initiative grows, we will collect more ongoing projects associated with the overall goals of MITNB here. 
<!-- ```{=html} -->

<!-- <img src="files/images/logo_mitnb.png" style="height: 50%; width: 50%; object-fit: contain"/> -->
<!-- ``` -->
...
**Principle Investigator:** Dominique Maciejewski ([Homepage](https://research.tilburguniversity.edu/en/persons/dominique-maciejewski)) \
